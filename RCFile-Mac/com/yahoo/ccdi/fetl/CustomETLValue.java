...
public class CustomETLValue extends org.apache.hadoop.hive.serde2.columnar.BytesRefArrayWritable {
//org.apache.hadoop.record.Record {
  ...
  throws java.io.IOException {
    ...
    _rio_a.writeLong(transformErrorTag,"transformErrorTag");
    {
      ...
      com.yahoo.ccdi.fetl.RcUtil.writeInt(this, simpleFields.size(), index++);
      ...
      for(java.util.Iterator<java.util.Map.Entry<String,org.apache.hadoop.record.Buffer>> _rio_midx1 = _rio_es1.iterator(); _rio_midx1.hasNext();) {
        ...
        com.yahoo.ccdi.fetl.RcUtil.writeString(this, _rio_k1, index++);
        //_rio_a.writeBuffer(_rio_v1,"_rio_v1");
        com.yahoo.ccdi.fetl.RcUtil.writeBuffer(this, _rio_v1, index++);
      }
      //_rio_a.endMap(simpleFields,"simpleFields"); // no-op
    }
    {
    ...
    }
    {
      ...
      for(java.util.Iterator<java.util.Map.Entry<String,java.util.ArrayList<java.util.TreeMap<String,org.apache.hadoop.record.Buffer>>>> _rio_midx1 = _rio_es1.iterator(); _rio_midx1.hasNext();) {
        ...
        _rio_a.writeString(_rio_k1,"_rio_k1");
        {
          ...
          com.yahoo.ccdi.fetl.RcUtil.writeInt(this, _rio_v1.size(), index++);
  ...
  throws java.io.IOException {
    ...
    filterTag = com.yahoo.ccdi.fetl.RcUtil.readLong(this, indx++);
    //dhrTag=_rio_a.readLong("dhrTag");
    dhrTag = com.yahoo.ccdi.fetl.RcUtil.readLong(this, indx++);
    //transformErrorTag=_rio_a.readLong("transformErrorTag");
    transformErrorTag = com.yahoo.ccdi.fetl.RcUtil.readLong(this, indx++);
    {
//      org.apache.hadoop.record.Index _rio_midx1 = _rio_a.startMap("simpleFields");
      int index = com.yahoo.ccdi.fetl.RcUtil.readInt(this, indx++);
...
//      for (; !_rio_midx1.done(); _rio_midx1.incr()) {
      for ( int i = 0; i< index; i++) {
        ...
        _rio_k1=com.yahoo.ccdi.fetl.RcUtil.readString(this, indx++);
        org.apache.hadoop.record.Buffer _rio_v1;
        //_rio_v1=_rio_a.readBuffer("_rio_v1");
        _rio_v1=com.yahoo.ccdi.fetl.RcUtil.readBuffer(this, indx++);
    ...
    }
    {
      ...
      for (; !_rio_midx1.done(); _rio_midx1.incr()) {
        ...
        java.util.ArrayList<java.util.TreeMap<String,org.apache.hadoop.record.Buffer>> _rio_v1;
        {
          ...
          int vector_index = com.yahoo.ccdi.fetl.RcUtil.readInt(this, indx++);
...
//    if (!(_rio_peer_ instanceof CustomETLValue)) {
//      throw new ClassCastException("Comparing different types of records.");
//    }
//    CustomETLValue _rio_peer = (CustomETLValue) _rio_peer_;
//    int _rio_ret = 0;
...
//    CustomETLValue _rio_other = new CustomETLValue();
...
//  
//  static {
//    org.apache.hadoop.record.RecordComparator.define(CustomETLValue.class, new Comparator());
//  }
}
