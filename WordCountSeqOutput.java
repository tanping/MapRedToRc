...
import org.apache.hadoop.util.ToolRunner;
   ...
   */
  public class WordCountSeqOutput extends Configured implements Tool {
    ...
    public static class Reduce extends MapReduceBase
      implements Reducer<Text, IntWritable, Text, /*IntWritable*/Text> {
      
      public void reduce(Text key, Iterator<IntWritable> values,
                         OutputCollector<Text, /*IntWritable*/Text> output, 
                         Reporter reporter) throws IOException {
        int sum = 0;
        while (values.hasNext()) {
          sum += values.next().get();
...
//      conf.setMapOutputCompressorClass(org.apache.hadoop.io.compress.GzipCodec.class);
    ...
    public static void main(String[] args) throws Exception {
      int res = ToolRunner.run(new Configuration(), new WordCountSeqOutput(), args);
      System.exit(res);
    }
